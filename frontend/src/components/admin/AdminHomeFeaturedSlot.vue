  ...
  <article class="admin-home-featured-slot">
    <label class="admin-home-featured-slot__pick">
      ...
      <select
        ...
        :disabled="disabled"
        :aria-label="`Choose a wanna do for featured slot ${slotNumber}`"
        @change="onSelectChange"
      >
        <option value="">— Choose a wanna do —</option>
        <option
    ...
    <p v-else class="admin-home-featured-slot__empty">
      Select a wanna do to preview the same card as the Wanna Do's page.
    </p>
  </article>
</template>
