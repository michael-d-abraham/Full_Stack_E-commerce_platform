<template>
  <div class="book-appointment">
    ...
    <p v-else class="book-appointment__pending lead">
      Booking link not configured yet. Add one in Admin → Book.
    </p>
  </div>
</template>
...
const BOOK_KEY = 'madd-lines-book-page';
...
const hasBookingUrl = computed(() => Boolean(bookingUrl.value && bookingUrl.value.trim()));
